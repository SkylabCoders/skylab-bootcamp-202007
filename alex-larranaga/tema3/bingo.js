...
function bingo() {
    ...
    while (newCard[0] != "X" || newCard[1] != "X" || newCard[2] != "X" || newCard[3] != "X" || newCard[4] != "X" && confirm("Wanna keep playin'?"))
    if (newCard[0] === "X" && newCard[1] === "X" && newCard[2] === "X" && newCard[3] === "X" && newCard[4] === "X"){
...
function generateCard() {
    var randomNumber = [], numsLen = 5, maxNum = 10, num;
