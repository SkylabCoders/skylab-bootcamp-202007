      ...
      <ul>
        {products.map((product) => (
          <li className="container-list__element" key={product.name}>
            ...
            <button className="element-button"><img src="https://trello-attachments.s3.amazonaws.com/5efafdc8c11d2a7055ac17ca/5f6708afcfada7261d3ec502/effece3bfc67a6ca5c71e84345f3a583/add-to-cart.png" /></button>
          </li>
        ))}
      </ul>
    </div>
