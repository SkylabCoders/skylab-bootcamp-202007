	...
	return (
		<section className="privacy-container">
			...
			<p>
				...
				Privacy Notice describes how Andefain, AndefainPro, Box Office Mojo, and
				DPReview.com (collectively “Andefain”) collect and process your personal
				information through Andefain websites, services, and applications that
				reference this Privacy Notice (together the “Andefain Services”).{' '}
				<strong>
					By using the Andefain Services, you are consenting to the practices
			...
			<ul>
				<li>
					...
					information you provide in relation to Andefain Services.&nbsp;Click{' '}
					&nbsp;to see examples of what we collect. You can choose not to
					provide certain information, but then you might not be able to take
					advantage of many of our Andefain Services.
				</li>
				<li>
					<strong>Automatic Information</strong>: We automatically collect and
					store certain types of information about your use of Andefain
					Services, including information about your interaction with content
					and services available through Andefain Services. Like many websites,
					we use “cookies” and other unique identifiers, and we obtain certain
					types of information when your web browser or device accesses Andefain
					Services and other content served by or on behalf of Andefain on other
					websites.&nbsp;Click &nbsp;to see examples of what we collect.
				</li>
				<li>
					...
					address when you sign in to Andefain using a third-party login
					service.&nbsp;Click &nbsp;to see additional examples of the
