	...
	return (
		<section className="about-container">
			...
			<p>
				...
				(i.e. the Andefain corporate logo and designs that represent the
				Andefain group). It should be noted that the Andefain group here implies
				both Andefain Inc. and its subsidiary companies.
			</p>
			<p>
				...
				confirm the compliance status of all design deliverables. In this case,
			...
			<p>
				...
				violations of the regulations and illegal usage of the Andefain logo or
			...
			<p>
				...
				not abiding by the brand rules, potential damage to Andefain’s group
				image may occur. Therefore, please adhere to the rules properly when
