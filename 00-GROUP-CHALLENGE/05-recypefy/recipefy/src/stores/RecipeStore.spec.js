...
describe('RecipeStore', () => {
    beforeEach(() => {
        ...
        action = reduceAction(actionTypes.LOAD_RECIPE, [{ title: 'Grilled Tofu Salad With Miso Dressing', source: 'Steamy Kitchen' }, { title: 'potato', source: 'Steamy Kitchen' }, { title: 'tomato', source: 'Steamy Kitchen' }, { title: 'Chicken', source: 'Steamy Kitchen' }, { title: 'Pie', source: 'Steamy Kitchen' }]);
    ...
    it('should register GET_RECIPE_BY_TITLE', () => {
        ...
        expect(recipeStore.getRecipeByTitle('Grilled Tofu Salad With Miso Dressing')).toEqual(action.data[0]);
    });
